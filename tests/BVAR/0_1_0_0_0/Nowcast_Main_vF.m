...
% NB: if do_loop=2
Loop.list_name = 'Eval_list_BVAR.xlsx'; % Name of excel with list of models (has to be located in folder 'eval/country.name/')
...
outputfolder = strcat('C:/Demos/p1760464/tests/BVAR/');
rootfolder = cd;
...
excel_outputfile = strcat('C:/Demos/p1760464/tbx/nowcastingTemplateData/',country.name,'_tracking.xlsx'); % Excel file containing tracking and news decomposition
Loop.excel_loopfile = strcat('C:/Demos/p1760464/tbx/nowcastingoutputData/',country.name,'_',country.model,'_loop_',Loop.name_loop,'.xlsx'); % Excel file for loop over random models
